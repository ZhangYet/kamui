export const DefaultWorkDirKey: string = 'defaultKamuiWorkDir';
export const BuildingProgressTitle: string = 'bookdown is building';
export const BuildingSuccessfuleMsg: string = 'bookdown building is completed successfully';
